...
public class MainActivity extends AppCompatActivity implements GetRawData.OnDownloadComplete {
    ...
    // Callback method that gets called when something happens in the called object (e.g. GetRawData).
    // The called object (class) will then get a reference to the caller object containing this method.
    @Override
